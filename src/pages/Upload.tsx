 ...
 * Allows users to upload CSV or Excel files for processing
 */
const UploadPage: React.FC = () => {
  ...
  const onDrop = useCallback(
    ...
    [uploadFile, navigate, resetUpload]
  );
  ...
  /**
   * Handler for sample file downloads
   * @param url - URL of the sample file
   */
  const handleDownloadSample = (url: string): void => {
    window.open(url);
  };
      ...
      <div className="max-w-3xl mx-auto py-12 bg-white bg-opacity-90 rounded-lg shadow-sm px-6">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload your financial data to generate beautiful visualizations
          </p>
        </div>
          ...
          {uploadStatus.isUploading ? (
            <div className="py-4">
              ...
              <LoadingProgressBar
                ...
                progress={uploadStatus.progress || loadingProgress}
            ...
            <div>
              <UploadIcon size={48} className="mx-auto mb-4 text-primary-500" />
              <h3 className="text-lg font-medium mb-1 text-gray-800">
                {isDragActive ? "Drop the file here" : "Upload your financial data"}
              </h3>
        ...
        <div className="mt-8 bg-gray-50 p-6 rounded-lg border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button
              ...
              onClick={() => handleDownloadSample("/sample-data/projects.csv")}
            >
            ...
            <Button
              variant="outlined"
              className="justify-start bg-white"
              onClick={() => handleDownloadSample("/sample-data/financials.csv")}
            >
              <FileText size={16} className="mr-2 text-primary-500" />
