...
// Design system components are commented out as they are only used for demo purposes
      ...
      <Box component="main" sx={{ flexGrow: 1, position: "relative", zIndex: 1 }}>
        ...
        <Box
          sx={{
            ...
            inset: 0,
            background: isDark
              ? "linear-gradient(to bottom, rgba(30, 41, 59, 0.6), rgba(15, 23, 42, 0.6))"
              : "linear-gradient(to bottom, rgba(238, 242, 255, 0.3), rgba(249, 250, 251, 0.2))",
            pointerEvents: "none",
            zIndex: 0,
          }}
          aria-hidden="true"
        ...
        <Routes>
          ...
          <Route
            path="/"
            element={
              hasData ? <Navigate to="/dashboard" replace /> : <Navigate to="/upload" replace />
            }
          />
          ...
          <Route
            path="/dashboard"
            element={hasData ? <Dashboard /> : <Navigate to="/upload" replace />}
          />
          <Route path="/upload" element={<Upload />} />
          <Route path="/settings" element={<Settings />} />

          {/* Design System Demo routes - commented out as they are only for documentation purposes
          ...
          {exportEnabled && (
            <Route
              path="/export"
              element={hasData ? <ExportPage /> : <Navigate to="/upload" replace />}
            />
          )}
